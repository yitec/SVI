...
$("#btn_aceites").live("click", function(event){
		...
		async: false,
        url: "operaciones.php",
        data: "opcion=9&marca="+$('#cmb_marca').val()+"&modelo="+$('#cmb_modelo').val()+"&filtros="+$('#cmb_filtros').val()+"&monto="+$('#precio_lavado').val()+"&cliente="+cliente+"&placa="+placa+" &pago="+pago+"&conductor="+conductor,
        success: function(datos){	
...
$("#btn_lavado").live("click", function(event){
		...
		async: false,
        url: "operaciones.php",
        data: "opcion=11&combol="+$('#cmb_combol').val()+'&tipoVehiculol='+$('#cmb_tipoVehiculol').val()+"&monto="+$('#precio_lavado').val()+"&cliente="+cliente+"&placa="+placa+" &pago="+pago+"&conductor="+conductor,
        success: function(datos){	
...
function actualiza_filtros(){
        ...
        success: function(datos){
			...
			$('#precio_aceite').attr("value",v_resultado[1]);
		}//end succces function
		});//end ajax function	
