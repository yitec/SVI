...
$fecha_fin=$hoy." 23:59:59";
	...
	$result = mysql_query("select COUNT(placa)as total from tbl_subfacturas  where nombre like '%Lavado%' and fecha>'".$fecha_ini."' and fecha<'".$fecha_fin."' and estado=1 ");
	$row=mysql_fetch_assoc($result);
...
<div id="box">
  ...
  <table width="974">
    <tr>
  <td width="642"><div align="right" class="Arial18Azul">
 Ingrese el código y la cantidad</div>  </td> <td width="178"><div align="right" class="Arial14Negro">Placa:</div></td><td width="76"><div>
    <input class="inputbox" size="8" id="txt_orden" name="txt_orden" type="text"  />
  </div></td><td width="58"><div>
    <input name="btn_search" id="btn_search" type="image" src="img/search.png" />
  </div></td>
  </tr>
    <tr>
      <td><div  style=" margin-left:400px; float:left;" class="Arial10gris">Total Lavados de hoy =<?=$row['total'];?>&nbsp;&nbsp;</div><div  class="Arial10gris" id="lcliente"></div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
  ...
  <table width="1150" >
    ...
    <tr>
    <td width="73"  class="Arial14Negro" >Cédula =</td>
      <td width="70"><div >
        <input class="inputbox" size="10" id="txt_cedula" name="txt_cedula"  type="text" />
      </div></td>
      <td width="65" class="Arial14Negro" >Cliente =</td>
      <td width="150"><div >
        <input class="inputbox" id="txt_cliente" name="txt_cliente"  type="text" />
      </div></td>
      <td width="55" class="Arial14Negro">Placa =</td>
      <td width="66"><div  >
        <input class="inputbox" name="txt_placa" size="10" id="txt_placa"  type="text" />
      </div></td>
      <td width="78" class="Arial14Negro">Conductor =</td>
      <td width="161"><div class="Arial14Negro" >
        <input class="inputbox"  name="txt_conductor" id="txt_conductor" type="text" />
      </div></td>
      
      <td width="53"><div class="Arial14Negro">Modo=</div></td>
      <td width="215"><select class="combo" name="cmb_metodo" id="cmb_metodo">
  ...
  <table width="1150" >
    ...
    <tr>
      <td width="71" class="Arial14Negro" ># Orden  =</td>
      <td width="154" ><div>
        <input class="inputbox" id="txt_contrato" name="txt_contrato"  type="text" />
      </div></td>
      <td width="75" class="Arial14Negro">Vehiculo = </td>
      <td width="155" ><div>
        <input class="inputbox" name="txt_vehiculo" id="txt_vehiculo"  type="text" />
      </div>
      </td>
      <td width="78" class="Arial14Negro">Kilometraje =</td>
      <td width="150" ><div class="Arial14Negro" >
        <input class="inputbox"  name="txt_kilometraje" id="txt_kilometraje" type="text" />
      </div></td>
      <td width="52" class="Arial14Negro">Letras =</td>
      <td width="259" ><div class="Arial14Negro" >
        <input class="inputbox"  name="txt_letras" id="txt_letras" type="text" />
      </div></td>
    </tr>
  </table>
  <table width="998">
    <tr>
      <td width="78" class="Arial14Negro" >C&oacute;digo =</td>
      <td width="150"><div >
        <input class="inputbox" id="txt_codigo" name="txt_codigo" type="text" />
      </div></td>
      <td width="98" class="Arial14Negro"><div align="center">Cantidad =</div></td>
      <td width="261"><div >
        <input class="inputbox" name="txt_cantidad"  id="txt_cantidad" type="text" />
      </div></td>
      <td width="387"><div align="right">
        <label>
        ...
        <label>
          <a id="various1"  href="#inline1"><img src="img/pagar.png" width="75" height="41" /></a> </label>
        </div></td>
      </tr>
    </table>
    ...
    <tr>
      ...
      <td width="202" ><select class="combos" name="cmb_combol" id="cmb_combol" onchange="actualiza_lavado()">
      ...
      <td width="247" ><select class="combos" name="cmb_tipoVehiculol" id="cmb_tipoVehiculol" onchange="actualiza_lavado()">
        <option>Seleccione</option>
        <option >Sedan</option>
        <option >4x4</option>
        <option >Motos</option>        
        ...
        <option >Estilos Peq</option>
        <option >Estilos Grande</option>
      </select>
...
<div style="display: none;">
		...
		<div id="inline1" style="width:600px;height:500px;overflow:auto;">
            ...
            <input type="image" name="btn_completo" id="btn_completo" src="img/completo.png" />
