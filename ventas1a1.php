...
<script src="includes/Scripts_Ventas1a1.js" type="text/javascript"></script> 
...
<div style=" width:800px; margin-left:0px; height:200px; margin-top:10px; float:left;">
  ...
  <div align="center" class="spiffyfg"><table width="783">
    <tr>
...
<div id="main"  width:780px;"><!--cuadro blanco-->
<table cellpadding="0" cellspacing="0" border="0">
<th>
<tr>
<td><img src="img/azul_izquierda.png" /></td>
<td><div align="center" class=" Arial14blanco" id="consecutivo"  style=" height:20px; width:750px;background: #7ac9e9;"> Detalle de la factura <?=$_SESSION['consecutivo']; ?></div></td>
